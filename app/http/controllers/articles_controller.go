...
func (ac *ArticlesController) Show(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		//4.读取成功
		view.Render(w, view.D{"Article":articles, "CanModifyArticle": policies.CanModifyArticle(articles)}, "articles.show", "articles._article_meta")
	}
}
...
func (*ArticlesController) Store(w http.ResponseWriter, r *http.Request) {
	...
	if len(errors) == 0 {
		...
		view.Render(w, view.D{"Article":_article,"Errors":errors}, "articles.create", "articles._form_field")
	}
}
